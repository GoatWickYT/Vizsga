 ...
 */
export async function getAllBuffets(): Promise<Buffet[]> {
    return queryRows<Buffet>('SELECT * FROM buffets');
}
 ...
 */
export async function getSingleBuffet(id: number): Promise<Buffet | null> {
 ...
 */
export async function createBuffet(Buffet: Buffet): Promise<number> {
 ...
 */
export async function updateBuffet(id: number, Buffet: Partial<Buffet>): Promise<boolean> {
 ...
 */
export async function deleteBuffet(id: number): Promise<boolean> {
