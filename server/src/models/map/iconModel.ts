...
export const getAllIcons = async (): Promise<Icon[]> => {
    return await queryRows<Icon>('SELECT * FROM icons');
};
 ...
 */
export const getSingleIcon = async (id: number): Promise<Icon | null> => {
 ...
 */
export const createIcon = async (Icon: Icon): Promise<number> => {
 ...
 */
export const updateIcon = async (id: number, Icon: Partial<Icon>): Promise<boolean> => {
 ...
 */
export const deleteIcon = async (id: number): Promise<boolean> => {
